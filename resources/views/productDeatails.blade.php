        ...
        <div class="max-w-6xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 bg-white p-8 rounded-[32px] shadow-sm border border-gray-100">
                ...
                <div class="relative group">
                    ...
                    <button class="absolute top-4 right-4 bg-white/90 backdrop-blur-md p-3 rounded-full shadow-md text-gray-400 hover:text-red-500 transition-all duration-300 active:scale-90">
                ...
                <div class="flex flex-col justify-center">
                    <div class="flex items-center space-x-2 mb-4">
                        ...
                        <span class="text-xs text-gray-500 font-bold uppercase tracking-tighter">Stock: {{ $product->stock }}</span>
                    </div>
                    ...
                    <div class="mt-4 flex items-baseline space-x-2">
                        ...
                        <span class="text-gray-400 text-sm font-medium line-through">${{ number_format($product->price * 1.2, 2) }}</span>
                    </div>
                    ...
                    <div class="mt-8 flex items-center p-4 bg-gray-50 rounded-2xl border border-gray-100">
                        <div class="w-10 h-10 rounded-full bg-[#1DB954] flex items-center justify-center text-white font-bold mr-3 shadow-sm">
                            {{ substr($product->seller->name ?? 'S', 0, 1) }}
                        </div>
                        <div>
                            <p class="text-[10px] text-gray-400 uppercase font-black">Marchand Certifié</p>
                            <p class="text-sm font-bold text-[#0F172A]">{{ $product->seller->name ?? 'Vendeur LocalMart' }}</p>
                        </div>
                    </div>
