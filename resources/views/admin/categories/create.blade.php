        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            <form action="#" method="POST" class="p-8 space-y-8">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <input type="text" id="name" name="name" placeholder="e.g. Smart Watches" required
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex rounded-xl overflow-hidden border border-gray-200 bg-gray-50 focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 transition">
                        ...
                        <input type="text" id="slug" name="slug" placeholder="smart-watches" required readonly
                ...
                <div class="pt-6 border-t border-gray-100 flex items-center justify-end gap-3">
                    ...
                    <button type="submit" class="px-6 py-2.5 bg-[#2563eb] text-white rounded-xl hover:bg-blue-700 transition font-bold text-sm shadow-md shadow-blue-200">
