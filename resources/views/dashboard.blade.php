<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-10">
            ...
            <div class="space-y-6">
                <div class="flex justify-between items-end px-2">
                    <div>
                        <h3 class="text-2xl font-black text-[#0F172A] tracking-tight">Produits en vedette</h3>
                        <p class="text-gray-500 text-sm">Articles soigneusement sélectionnés pour votre style.</p>
                    </div>
    ...
    <div id="modal-container" class="fixed inset-0 z-50 hidden items-center justify-center bg-[#0F172A]/60 backdrop-blur-sm">
        <div class="bg-white rounded-3xl w-96 p-8 relative shadow-2xl border border-gray-100">
            <h3 id="modal-title" class="text-xl font-bold text-[#0F172A] mb-6">Ajouter au panier ?</h3>
            <div class="flex flex-col space-y-3">
                <form id="modal-form" method="POST" action="" class="w-full"> 
                    @csrf
                    <button type="submit" class="w-full bg-[#1DB954] text-white px-4 py-3 rounded-xl font-bold hover:bg-[#16a34a] shadow-lg shadow-green-200 transition-all">
                        Confirmer l'ajout
                    </button>
                </form>
                <button id="modal-cancel" class="w-full bg-gray-100 text-gray-600 px-4 py-3 rounded-xl font-bold hover:bg-gray-200 transition-all">
                    Annuler
                </button>
            </div>
            <button id="modal-close" class="absolute top-4 right-4 text-gray-400 hover:text-gray-600 text-2xl">&times;</button>
        </div>
    </div>
</x-app-layout>